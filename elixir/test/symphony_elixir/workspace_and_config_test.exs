defmodule SymphonyElixir.WorkspaceAndConfigTest do
  ...
  test "config reads defaults for optional settings" do
    ...
    write_workflow_file!(Workflow.workflow_file_path(), cloud_gate_retry_cooldown_ms: 0)
    assert {:error, {:invalid_workflow_config, message}} = Config.validate!()
    assert message =~ "agent.cloud_gate_retry_cooldown_ms"

    write_workflow_file!(Workflow.workflow_file_path(), local_bench_gate_retry_cooldown_ms: 0)
    assert {:error, {:invalid_workflow_config, message}} = Config.validate!()
    assert message =~ "agent.local_bench_gate_retry_cooldown_ms"
    ...
    write_workflow_file!(Workflow.workflow_file_path(),
      ...
      cloud_gate_retry_cooldown_ms: 0,
      local_bench_gate_retry_cooldown_ms: 0,
