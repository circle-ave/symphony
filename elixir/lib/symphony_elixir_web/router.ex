defmodule SymphonyElixirWeb.Router do
  ...
  scope "/", SymphonyElixirWeb do
    ...
    match(:*, "/api/v1/controls", ObservabilityApiController, :method_not_allowed)
    post("/api/v1/refresh", ObservabilityApiController, :refresh)
    match(:*, "/api/v1/refresh", ObservabilityApiController, :method_not_allowed)
    post("/api/v1/freeze", ObservabilityApiController, :freeze)
    match(:*, "/api/v1/freeze", ObservabilityApiController, :method_not_allowed)
