defmodule SymphonyElixir.Linear.Issue do
  ...
  defstruct [
    ...
    :active_workpad_comment_id,
    :active_workpad_body,
    :active_workpad_updated_at,
    blocked_by: [],
    labels: [],
  ...
  @type t :: %__MODULE__{
          ...
          latest_comment_id: String.t() | nil,
          latest_comment_body: String.t() | nil,
          latest_comment_created_at: DateTime.t() | nil,
          latest_comment_user_id: String.t() | nil,
          latest_comment_user_name: String.t() | nil,
          active_workpad_comment_id: String.t() | nil,
          active_workpad_body: String.t() | nil,
          active_workpad_updated_at: DateTime.t() | nil,
          labels: [String.t()],
