defmodule SymphonyElixir.Codex.AppServer do
  ...
  defp handle_incoming(port, on_message, data, timeout_ms, tool_executor, auto_approve_requests) do
    ...
    case Jason.decode(payload_string) do
      ...
      {:ok, %{"method" => "error"} = payload} ->
        handle_turn_error(port, on_message, payload, payload_string)
  ...
  defp handle_turn_error(port, on_message, payload, payload_string) do
  ...
  defp dynamic_tool_wire_result(%{"success" => success, "contentItems" => content_items})
       when is_boolean(success) and is_list(content_items) do
    %{"contentItems" => content_items, "success" => success}
  end

  defp dynamic_tool_wire_result(%{"success" => success, "output" => output})
       when is_boolean(success) and is_binary(output) do
    %{"contentItems" => dynamic_tool_content_items(output), "success" => success}
  end

  defp dynamic_tool_wire_result(result) do
    %{"contentItems" => dynamic_tool_content_items(dynamic_tool_output(result)), "success" => false}
  end
