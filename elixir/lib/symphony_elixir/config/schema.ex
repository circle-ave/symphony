defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Tracker do
    ...
    embedded_schema do
      ...
      field(:oauth_scope, :string, default: "read,write,app:assignable")
  ...
  defmodule Codex do
    ...
    embedded_schema do
      ...
      field(:tool_allowlist, :map, default: %{})
  ...
  defp finalize_settings(settings) do
        ...
        | api_key: resolve_secret_setting(settings.tracker.api_key, System.get_env("LINEAR_API_KEY")),
          ...
          oauth_scope:
            resolve_secret_setting(
              settings.tracker.oauth_scope,
              System.get_env("LINEAR_OAUTH_SCOPE") || "read,write,app:assignable"
            ),
    ...
    codex = %{
      ...
      | approval_policy: normalize_keys(settings.codex.approval_policy),
        ...
        tool_allowlist: normalize_optional_map(settings.codex.tool_allowlist) || %{}
    }
